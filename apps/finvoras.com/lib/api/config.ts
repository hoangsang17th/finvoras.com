...
export const resolveApiBaseUrl = (): string => {
    ...
    if (configured) {
        // Ensure it ends with a slash for consistency, though HttpClient now handles both
    ...
    if (process.env.NODE_ENV !== "production") {
        ...
        return FALLBACK_API_BASE_URL.endsWith("/") ? FALLBACK_API_BASE_URL : `${FALLBACK_API_BASE_URL}/`;
    }
