 ...
 */
export function getLanguageFromHeader(header: string | null | undefined): LegalLanguage {
 ...
 */
export function getLanguageFromCookie(cookieValue: string | null | undefined): LegalLanguage {
