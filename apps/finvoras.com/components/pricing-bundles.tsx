        ...
        <div className="py-16 px-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4">{bundles.title}</h2>
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto">{bundles.subtitle}</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="relative border rounded-xl p-6 bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-blue-950/20 dark:to-purple-950/20 hover:shadow-lg transition-shadow">
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">{bundles.student.duration}</p>
                            </div>
                        </div>
                        <p className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">{bundles.student.price}</p>
                        <p className="text-sm text-muted-foreground mb-6">{bundles.student.description}</p>
                        <Button variant="secondary" className="w-full mb-6 bg-blue-500/10 hover:bg-blue-500/20 text-blue-700 dark:text-blue-300">
                            {bundles.student.cta}
                        </Button>
                    ...
                    <div className="relative border rounded-xl p-6 bg-gradient-to-br from-pink-50/50 to-rose-50/50 dark:from-pink-950/20 dark:to-rose-950/20 hover:shadow-lg transition-shadow">
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">{bundles.couple.duration}</p>
                            </div>
                        </div>
                        <p className="text-3xl font-bold text-pink-600 dark:text-pink-400 mb-2">{bundles.couple.price}</p>
                        <p className="text-sm text-muted-foreground mb-6">{bundles.couple.description}</p>
                        <Button variant="secondary" className="w-full mb-6 bg-pink-500/10 hover:bg-pink-500/20 text-pink-700 dark:text-pink-300">
                            {bundles.couple.cta}
                        </Button>
                        <ul className="space-y-2">
                    ...
                    <div className="relative border-2 border-brand-primary rounded-xl p-6 bg-gradient-to-br from-orange-50/50 to-amber-50/50 dark:from-orange-950/20 dark:to-amber-950/20 hover:shadow-lg transition-shadow md:col-span-2 lg:col-span-1">
                        ...
                        <p className="text-3xl font-bold text-brand-primary mb-2">
                            {coaching.price}
                            <span className="text-sm font-normal text-muted-foreground">{coaching.pricePerSession}</span>
                        </p>
                        <p className="text-sm text-muted-foreground mb-6">{coaching.description}</p>
