...
const Pricing = () => {
	...
	const plans: Plan[] = [pricing.free, pricing.pro, pricing.family].filter(
	...
	return (
		...
		>
			...
			<p className="mt-4 text-xl text-muted-foreground text-center max-w-2xl">
				{pricing.subtitle}
			</p>
			...
			>
				<TabsList className="h-11 px-1.5 rounded-full bg-brand-primary/10">
					<TabsTrigger
						value="monthly"
						className="py-1.5 rounded-full data-[state=active]:bg-brand-primary data-[state=active]:text-white"
					>
						{pricing.monthly}
					</TabsTrigger>
					<TabsTrigger
