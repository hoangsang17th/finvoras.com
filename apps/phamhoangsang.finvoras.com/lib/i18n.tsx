...
type I18nTranslations = UITranslations & { resumeData: ResumeData };
...
export function useI18n() {
	const {
		...
		t,
	} = useSharedI18n<I18nTranslations>();
	...
	const setLocale = (newLocale: Locale) => {
		...
		const hasLocalePrefix =
			segments.length > 0 && (segments[0] === "en" || segments[0] === "vi");
	...
	const { resumeData, ...ui } = t as I18nTranslations;

	return {
		locale: locale as Locale,
		setLocale,
		ui: ui as UITranslations,
		resumeData,
	};
}
