...
I treat these problems as part of the engineering process—analyzing root causes, documenting lessons learned, and improving the system incrementally. My long-term goal is to grow as a product-oriented engineer who can bridge mobile development, system thinking, and business needs to build software that is reliable, scalable, and built to last.`,
		...
		quickInfo: [
			{
				...
				description: "Flutter in production environments",
			},
			{
			...
			},
			{
				label: "Edge Cases",
				value: "30+",
				description: "Handled in real-world scenarios",
			},
			{
				label: "Functional Scope",
				value: "Cross",
				description: "Mobile, backend integration, architecture",
			},
		],
		experiences: [
			{
				...
				description:
					"Lead Flutter development for core ERP modules and low-code platform transition, maintain 10+ modules.",
				technologies: [
					"Flutter",
					"Dart",
					"Clean Architecture",
			...
			},
			{
				...
				description:
					"Frontend development with ReactJS, system analysis, and deployment.",
		...
		additionalSkills: ["English (VSTEP B1 - Intermediate)"],
		projects: [
			{
...
Tôi xem những vấn đề này là một phần tự nhiên của quá trình kỹ thuật: phân tích nguyên nhân gốc rễ, ghi lại bài học rút ra và cải tiến hệ thống một cách tuần tự. Mục tiêu dài hạn của tôi là phát triển theo hướng product-oriented engineer — người có thể kết nối giữa mobile development, tư duy hệ thống và nhu cầu kinh doanh để xây dựng phần mềm ổn định, mở rộng được và bền vững theo thời gian.`,
		...
		quickInfo: [
			{
				...
				value: yearsExperience,
				description: "Flutter trong môi trường production",
			},
			{
				label: "Sản Phẩm FinTech",
				value: "1",
				description: "Sở hữu sản phẩm end-to-end",
			},
			{
				label: "Edge Cases",
				value: "30+",
				description: "Xử lý trong các tình huống thực tế",
			},
			{
				label: "Phạm Vi Chức Năng",
				value: "Đa dạng",
				description: "Mobile, tích hợp backend, kiến trúc",
			},
		],
		experiences: [
			{
				...
				description:
					"Dẫn dắt phát triển Flutter cho các module ERP cốt lõi và chuyển đổi nền tảng low-code, bảo trì hơn 10 module.",
				technologies: [
					"Flutter",
					"Dart",
					"Clean Architecture",
			...
			},
			{
				...
				description:
					"Phát triển Frontend với ReactJS, phân tích hệ thống và triển khai.",
				technologies: ["ReactJS", "JavaScript", "Figma", "Netlify"],
				role: "Frontend Intern",
		...
		additionalSkills: ["Tiếng Anh (VSTEP B1 - Trung cấp)"],
	},
};
