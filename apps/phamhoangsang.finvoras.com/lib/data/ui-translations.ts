...
export const uiTranslations: Record<"en" | "vi", UITranslations> = {
	en: {
		...
		sections: {
			...
			skills: {
				title: "Skills",
				subtitle: "Technologies I work with, and the thinking behind them.",
			},
			contact: {
				title: "Let’s talk",
				subtitle:
	...
	vi: {
		...
		sections: {
			...
			experience: {
				title: "Kinh nghiệm",
				subtitle: "Từ lúc ship tính năng đến khi giữ nó chạy ổn định lâu dài.",
			},
			skills: {
				title: "Kỹ năng",
				subtitle: "Công cụ mình quen tay - và luôn sẵn sàng học điều mới.",
			},
			contact: {
				title: "Cùng trò chuyện",
				subtitle: "Có ý tưởng, vị trí phù hợp, hay vấn đề cần gỡ? Cứ nói nhé.",
			},
