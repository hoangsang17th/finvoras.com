...
export const getActionMetadata = (url: string, ui: UITranslations) => {
		...
		switch (status) {
			case "live":
				return {
					label: "Live",
					variant: "default" as const,
					className: "bg-brand-success text-white border-none",
				};
			case "in_development":
				return {
					label: "In Dev",
						...
						return (
							...
							>
								...
								<div className="relative h-48 bg-muted overflow-hidden">
									...
									<div className="absolute top-3 left-3">
										<Badge
											variant="outlined"
											size="sm"
											className="bg-background/90 flex items-center gap-1"
										>
								...
								<div className="p-6 flex flex-col flex-1">
									<h3 className="text-lg font-bold mb-2 group-hover/card:text-brand-primary transition-colors">
										{project.title}
									</h3>
									...
									{/* Action Buttons */}
									<div
										className="flex gap-2.5 mt-auto flex-wrap"
