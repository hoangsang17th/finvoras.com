        ...
        faq: {
            ...
            questions: [
                ...
                },
                {
                    ...
                    answer: "Bạn có thể nâng cấp bất cứ lúc nào từ cài đặt tài khoản. Chỉ cần chọn gói bạn muốn (Pro hoặc Family), chọn phương thức thanh toán và bạn sẽ có quyền truy cập ngay vào tất cả tính năng cao cấp. Chúng tôi cung cấp thanh toán theo tháng và năm with ưu đãi tiết kiệm 15% cho gói năm.",
                    icon: "TrendingUp",
                },
                {
